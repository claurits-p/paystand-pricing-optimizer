...
# ── SaaS Defaults ──────────────────────────────────────────────
SAAS_ARR_DEFAULT = 24_000          # $/year (standard list price)
SAAS_IMPL_FEE_DEFAULT = 5_000      # $ one-time implementation fee
...
LEVER_BOUNDS = {
    ...
    "ach_cap":                {"min": 2.50, "max": 25.0, "default": 10.0, "step": 0.50},
    "ach_fixed_fee":          {"min": 1.00, "max": 5.00, "default": 2.50, "step": 0.25},
    "hold_days_cc":           {"min": 1, "max": 5, "default": 2, "step": 1},
    "hold_days_ach":          {"min": 3, "max": 7, "default": 4, "step": 1},
    "hold_days_bank":         {"min": 5, "max": 10, "default": 6, "step": 1},
}
...
WIN_PROB_DEFAULTS = {
    "floor": 0.15,        # 15% min win rate even at worst pricing
    "ceiling": 0.75,      # 75% max win rate even at best pricing
...
MARKET_BENCHMARKS = {
    ...
    "hold_days_ach": 4,           # typical ACH hold
    "hold_days_bank": 6,          # typical bank network hold
}
